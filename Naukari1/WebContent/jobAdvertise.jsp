...
<body style="vertical-align: middle;" background="images/back.png">
	...
	<div class="container" style="background-color: #fff;">
		...
		<div class="addDataParent" style="border-bottom: solid 2px #FF9800; padding-bottom: 15px; padding-top: 15px;">
			<div class="addTitle"
				style="font-size: 24px; font-weight: bold; padding-bottom: 5px;">
				<a href="AddDetail?addid=<%=ad.getAddId()%>"> <%=ad.getTitle()%>
				</a>
			</div>
			<div class="addInfo"	style="color: #9c8e8e; font-size: 15px; font-weight: bold;">
